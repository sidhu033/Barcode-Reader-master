...
public class QRScanActivity extends AppCompatActivity implements View.OnClickListener, BarcodeReaderFragment.BarcodeReaderListener
{
    ...
    private void launchBluetoothScan(String rawValue)
    {
        /**/
        Intent intent = new Intent(QRScanActivity.this, BluetoothScan.class);
        intent.putExtra("product_id",rawValue);
    ...
    public void onScanned(Barcode barcode)
    {
        ...
        launchBluetoothScan(barcode.rawValue);              //launch bluetooth scan activity
